...
static ChicleQoiLoader *
chicle_qoi_loader_new (void)
{
    return g_new0 (ChicleQoiLoader, 1);
}

ChicleQoiLoader *
chicle_qoi_loader_new_from_mapping (ChicleFileMapping *mapping)
{
    ChicleQoiLoader *loader = NULL;
    ...
    if (!chicle_file_mapping_has_magic (mapping, 0, "qoif", 4))
        goto out;

    loader = chicle_qoi_loader_new ();
...
void
chicle_qoi_loader_destroy (ChicleQoiLoader *loader)
{
    if (loader->mapping)
...
gboolean
chicle_qoi_loader_get_is_animation (ChicleQoiLoader *loader)
{
...
gconstpointer
chicle_qoi_loader_get_frame_data (ChicleQoiLoader *loader,
...
gint
chicle_qoi_loader_get_frame_delay (ChicleQoiLoader *loader)
{
    g_return_val_if_fail (loader != NULL, 0);
...
void
chicle_qoi_loader_goto_first_frame (ChicleQoiLoader *loader)
{
    g_return_if_fail (loader != NULL);
}

gboolean
chicle_qoi_loader_goto_next_frame (ChicleQoiLoader *loader)
{
