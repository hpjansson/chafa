...
{
    ChicleTiffLoader *loader = (ChicleTiffLoader *) obj;
...
{
    return g_new0 (ChicleTiffLoader, 1);
}

ChicleTiffLoader *
chicle_tiff_loader_new_from_mapping (ChicleFileMapping *mapping)
{
    ChicleTiffLoader *loader = NULL;
...
void
chicle_tiff_loader_destroy (ChicleTiffLoader *loader)
{
    if (loader->mapping)
...
gboolean
chicle_tiff_loader_get_is_animation (ChicleTiffLoader *loader)
{
...
gconstpointer
chicle_tiff_loader_get_frame_data (ChicleTiffLoader *loader,
...
gint
chicle_tiff_loader_get_frame_delay (ChicleTiffLoader *loader)
{
    g_return_val_if_fail (loader != NULL, 0);
...
void
chicle_tiff_loader_goto_first_frame (ChicleTiffLoader *loader)
{
    g_return_if_fail (loader != NULL);
}

gboolean
chicle_tiff_loader_goto_next_frame (ChicleTiffLoader *loader)
{
